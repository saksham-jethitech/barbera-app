        ...
        <Layout>
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex justify-around items-center space-x-6">
              <div className="w-1/5 bg-[#FBB033] rounded-3xl flex flex-col justify-around items-center space-y-10 px-5 py-7">
                ...
                <div className="bg-white w-1/2 py-7 rounded-md h-16 flex justify-center items-center">
              ...
              <div className="flex flex-col">
                <p className="text-[#FBB033] font-be-jost-pro text-xl font-bold">
                  Bookings
                </p>
